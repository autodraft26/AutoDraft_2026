...
class LlamaAttention(nn.Module):
    ...
    def _init_rope(self):
        ...
        if rope_theta is None:
            rs_tmp = getattr(self.config, "rope_scaling", None) or {}
            rope_theta = rs_tmp.get("rope_theta", 10000.0)
        ...
        if self.config.rope_scaling is None:
            ...
            # HF :
            # - legacy: {"type": "linear|dynamic", "factor": ...}
            # - newer : {"rope_type": "default|linear|dynamic", ...}
